    ...
    if (this.form.valid) {
      ...
      this.notificationService.info(
        (this.form.value.requestGift
          ? this.translate.instant('aofront.applications.form.text4')
          : this.translate.instant('aofront.applications.form.text5')) +
          ' : ' +
          this.translate.instant('aofront.applications.form.text6')
      );
    }
  }
