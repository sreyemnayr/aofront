...
describe('FormComponent', () => {
  ...
  it('should submit when form is valid', async () => {
    component.input(
      component.getByLabelText('aofront.applications.form.placeholder1'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('aofront.applications.form.placeholder2'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('aofront.applications.form.placeholder3'),
      {
        target: {
          value: 'foo@bar.baz'
        }
    ...
    component.input(
      component.getByLabelText('aofront.applications.form.placeholder5'),
      {
        target: {
          value: '1991-12-31'
        }
    ...
    component.input(
      component.getByLabelText('aofront.applications.form.placeholder4'),
      {
        target: {
    ...
    component.click(
      component.getByLabelText('aofront.applications.form.text1')
    );
    component.click(component.getByText('aofront.applications.form.send'));
